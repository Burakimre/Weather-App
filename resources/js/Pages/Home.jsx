    ...
    return (
        <>
            <div className="flex flex-col items-center">
                ...
                <img className="px-2" src={ `http://openweathermap.org/img/wn/${ props.icon }@2x.png` } alt="" />
        ...
        <>
            ...
            <div className="w-full h-screen bg-violet-500 text-white overflow-auto">
                <div className="flex flex-col items-center gap-y-2 py-4">
                    ...
                    <div className="w-full xxs:w-80 px-4 xxs:px-0 mt-12">
                        <div className="grid grid-cols-3 w-full py-6 bg-white rounded-lg text-black shadow-xl">
                            <div className="flex flex-col items-center">
                                ...
                                <span className="mt-4 text-base">{ props.weather.temperature.humidity }%</span>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="mt-4 text-base">{ props.weather.temperature.pressure } hPa</span>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="mt-4 text-base">{ props.weather.wind.speed } km/h</span>
                    ...
                    <div className="w-full xxs:w-80 px-4 xxs:px-0 mt-4">
                        <div className="grid grid-cols-5 w-full py-6 bg-white rounded-lg text-black shadow-xl">
