...
export default function Home() {
    ...
    useEffect(() => {
        Promise.all([
            fetch('/api/weather?latitude=55&longitude=0', {
                method: 'GET',
                headers: {
                    Authorization: 'Bearer DhCHrjTmZvC4Hf43U2KyH0Pc01cUnH7fN9PAcDO8'
                }
            }).then(res => res.json()),
            fetch('/api/forecast?latitude=55&longitude=0', {
                method: 'GET',
                headers: {
                    Authorization: 'Bearer DhCHrjTmZvC4Hf43U2KyH0Pc01cUnH7fN9PAcDO8'
                }
                    ...
                    { weather &&
                        <>
                            <div className="flex gap-3">
                                ...
                                <span className="text-xl">{ weather.city }</span>
                            </div>

                            <div className="flex">
                                <img src={ `http://openweathermap.org/img/wn/${ weather.weather.icon }@4x.png` } alt="" />
                            </div>

                            <div className="flex flex-col items-center">
                                <span className="text-7xl font-semibold">{ Math.round(weather.temperature.average) }°</span>
                                <span className="text-2xl">{ weather.weather.name }</span>
                            ...
                            <div className="w-full xxs:w-80 px-4 xxs:px-0 mt-8">
                                <div className="grid grid-cols-3 w-full py-6 bg-white rounded-lg text-black shadow-xl">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-base font-bold">{ weather.temperature.humidity }%</span>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-base font-bold">{ weather.temperature.pressure } hPa</span>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-base font-bold">{ weather.wind.speed } km/h</span>
                                    </div>
                                </div>
                            </div>
                        </>
